...
int main(int argc, char** argv) {
  ...
  v8::Isolate* isolate = v8::Isolate::New(create_params);
  {
    ...
    i::Compiler::GetSharedFunctionInfoForScript(orig_source,
                                                i::Handle<i::String>(), 0, 0,
                                                v8::ScriptOriginOptions(false, false, false, i::FLAG_nw_module),
                                                i::Handle<i::Object>(),
                                                i::Handle<i::Context>(iso->native_context()),
                                                nullptr, &cache,
                                                v8::ScriptCompiler::kProduceCodeCache,
                                                v8::ScriptCompiler::kNoCacheNoReason,
                                                i::NOT_NATIVES_CODE, i::Handle<i::FixedArray>());
