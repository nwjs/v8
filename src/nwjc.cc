...
int main(int argc, char** argv) {
  ...
  v8::Isolate* isolate = v8::Isolate::New(create_params);
  {
    ...
    i::MaybeHandle<i::SharedFunctionInfo> maybe_func = i::Compiler::GetSharedFunctionInfoForScript(orig_source,
    ...
    cache = i::CodeSerializer::Serialize(iso, func, orig_source);
